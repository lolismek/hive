...
export function FileViewer({ path, content, onClose }: FileViewerProps) {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black/50 backdrop-blur-sm" style={{ zIndex: 9999 }} onClick={onClose}>
      <div
        className="bg-[var(--color-surface)] border border-[var(--color-border)] rounded-2xl shadow-2xl max-w-4xl w-full mx-6 my-10 animate-fade-in max-h-[calc(100vh-5rem)] flex flex-col overflow-hidden"
